    ...
    <section className="max-w-4xl mx-auto px-6 py-8">
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          {/* Discord Logo - Floating Animation */}
          <motion.div
            animate={{
              y: [0, -20, 0],
              rotate: [0, 5, -5, 0],
          ...
          >
            ...
            {[0, 1, 2].map((i) => (
              ...
              >
                <div
                  className="absolute w-1 h-1 bg-indigo-400 rounded-full shadow-md shadow-indigo-400/50"
                  style={{
                    top: `${20 + i * 10}%`,
                    left: "50%",
        ...
        >
          ...
          <motion.p
            ...
            className="text-gray-400 text-[10px] mb-3"
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center md:items-start">
            ...
            >
              ...
              {/* Button Container */}
              <motion.a
                href="https://discord.gg/b5Rp8eUv"
                target="_blank"
                rel="noreferrer"
                whileHover={{
                  scale: 1.05,
